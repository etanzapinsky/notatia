...
var linked_template = _.template('<h5 class="title"><span><%= title %></span><button class="btn btn-danger pull-right link">Unlink</button></h5><% if (path) { %><p class="text-center"><img src="<%= path %>" /><% } else { %><p><%= text %><% } %></p>');
var unlinked_template = _.template('<h4 class="title"><span><%= title %></span><button class="btn btn-success pull-right link">Link</button></h4><% if (path) { %><p class="text-center"><img src="<%= path %>" /><% } else { %><p><%= text %><% } %></p>');
...
var StreamCapsuleView = CapsuleView.extend({
    ...
    template: _.template('<h3 class="title"><%= title %></h3><% if (path) { %><p class="text-center"><img src="<%= path %>" /><% } else { %><p><%= text %><% } %></p>')
});
